if (!isMobile) {
    ...
    let intAnim = function () {
        ...
        gsap.timeline({}).to(".scroll-circle", {
            duration: 1, ease: 'power1.inOut', opacity:1, alpha:1,
        },"1")
        ...
        gsap.timeline({}).to(".scroll-arrow svg", {
          y:-19,
            duration: 1.1, ease: 'power1.in', opacity:1,
        })
    ...
    let preloader = function () {
        ...
        countTimeline.from(".el-bg",{opacity:0,
            duration: 0.5,
            ease: "power4.inOut"
        }, "-=0.8")
        countTimeline.from(".en-logo img",1.2,{opacity:0,
            duration: 0.5,y:300,
            ease: "power4.inOut"
        }, "-=0.7")
        countTimeline.from(".hro-img",1.2,{opacity:0,
            duration: 0.5,y:300,
            ease: "power4.inOut"
        }, "-=0.7")
        countTimeline.from(".module--header__bg",1,{opacity:0,
            duration: 0.5,x:-100,
            ease: "power4.inOut"
        }, "-=0.6")
        
        countTimeline.from(".about-us-image img",1,{ y: "200",
        duration: 1,
        opacity:0,
        transformOrigin:"bottom",
        ease: "power4.inOut"
    }, "-=1.2")
    countTimeline.to(".tris_titles span",2,{ y: "0",
        duration: 0.5,
        ease: "power4.inOut"
    }, "-=0.9")
    countTimeline.from(".text-rveal span",1,{ y: "180",
        duration:0.5,
    }, "-=2")
    countTimeline.from(".element",1,{ scale:0,
        duration:0.5,opacity:0
    }, "-=1.8")
    countTimeline.from(".top-img img",1,{
        duration:0.5,opacity:0,transformOrigin:"left",x:-100
    }, "-=1.3")
    countTimeline.from(".welcome-heading",2,{opacity:0,
    duration: 1,
    ease: "power4.inOut"
}, "-=1.6")
